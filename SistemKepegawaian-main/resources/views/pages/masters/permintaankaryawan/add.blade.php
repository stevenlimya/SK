                ...
                <form class="form theme-form" id="input-form" action="{{ url($information['route']) }}/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                    <label class="form-label" for="select-input-karyawan_id">Nama Pemohon</label>
                        ...
                        <input class="form-control input-air-primary" id="pemohon" name="pemohon" type="hidden" placeholder="Pemohon" />
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                        <label class="form-label" for="select-input-divisi">Divisi Pemohon</label>
                                        <select name="divisi_pemohon" id="divisi_pemohon" class="form-control input-air-primary">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-keterangan" name="keterangan" type="text" placeholder="Alasan Permintaan" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                        ...
                                        <select name="divisi" id="divisi" class="form-control input-air-primary">
                                            <option value="" selected hidden>Pilih Divisi Yang Diminta</option>
                                            <option value="HRD">HRD</option>
                                            <option value="Information And Technology">Information And Technology</option>
                                            <option value="Penjualan">Penjualan</option>
                                            <option value="Finance">Finance</option>
                ...
                if (id) {
                    ...
                    $.ajax({
                        ...
                        success: function(karyawan) {
                            $('#pemohon').val(karyawan.nama);
                            if (karyawan.divisi) {
                                var divisiDropdown = '<option value="' + karyawan.divisi + '">' + karyawan.divisi + '</option>';
                                $('#divisi_pemohon').html(divisiDropdown);
                            } else {
                        $('#divisi_pemohon').empty(); // Mengosongkan dropdown divisi jika tidak ada data divisi
                    }
                        },
