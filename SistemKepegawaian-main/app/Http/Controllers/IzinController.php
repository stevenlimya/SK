...
class IzinController extends Controller
{
    public static $information = [
        "title" => "Izin",
        "route" => "/master/izin",
        "view" => "pages.masters.izin."
    ];
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $izin = Izin::join('karyawan', 'karyawan.id', '=', 'izin.karyawan_id')
                ->select("izin.*", "karyawan.nama as nama");
    ...
    public function update($id, Request $request)
    {
        ...
        $result = Izin::do_update($decrypt->id, $request);
        return response()->json($result["client_response"], $result["code"]);
    }
    ...
    public function destroy($id)
    {
        ...
        $result = Izin::do_delete($decrypt->id);
        return response()->json($result["client_response"], $result["code"]);
    }
