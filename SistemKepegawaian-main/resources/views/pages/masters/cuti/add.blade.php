...
<div class="container-fluid">
    <div class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="#">
            ...
            <span class="breadcrumb-text">Tambah Cuti </span>
        </a>
    </div>
            ...
            <div class="card">
                ...
                <form class="form theme-form" id="input-form" action="{{ url($information['route']) }}/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                    <label class="form-label" for="select-input-divisi_id">Nama</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-keterangan" name="keterangan" type="text" placeholder="Alasan Cuti" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-lama">Lama Hari</label>
                                    <input class="form-control input-air-primary" id="txt-input-lama" name="lama" type="text" placeholder="Jumlah Hari Cuti" />
                                </div>
                            </div>
                        </div>
