                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-nama" name="nama" type="text" placeholder="Masukkan Nama Pelamar" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                        ...
                                        <select name="divisi" id="select-input-divisi" class="form-control input-air-primary">
                        ...
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                        ...
                                        <select name="jeniskelamin" id="select-input-jeniskelamin" class="form-control input-air-primary">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-alamat" name="alamat" type="text" placeholder="Masukkan Alamat Pelamar" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggallahir" name="tanggallahir" type="date"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-notelepon" name="notelepon" type="text" placeholder="+628" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-email" name="email" type="text" placeholder="Masukkan Email Pelamar" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-nik">NIK</label>
                                    <input class="form-control input-air-primary" id="txt-input-nik" name="nik" type="text" placeholder="Masukkan Nomor NIK Pelamar" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-description">Masukkan File</label>
                                    <input class="form-control input-air-primary" id="txt-input-description" name="file" type="file" required/>
                                </div>
                            </div>
                        </div>
                    </div>
