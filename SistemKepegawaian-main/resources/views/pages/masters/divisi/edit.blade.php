    ...
    <div class="row starter-main">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="form theme-form" id="edit-form" action="{{ url($information['route']) }}/update/{{ Crypt::encrypt($divisi->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-divisi" name="divisi" type="text" placeholder="Divisi" value="{{ $divisi->divisi }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-description" name="description" type="text" placeholder="Keterangan" value="{{ $divisi->description }}" />
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $("#edit-form").submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "{{ url($information['route']) }}/update/{{ Crypt::encrypt($divisi->id) }}",
                data: form_data,
                processData: false,
                contentType: false,
