    ...
    <div class="row starter-main">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="form theme-form" id="edit-form" action="{{ url($information['route']) }}/update/{{ Crypt::encrypt($resain->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-nama">Nama</label>
                                     <input class="form-control input-air-primary" id="nama" name="nama" type="text" placeholder="Nama" value="{{ $resain->nama }}" readonly />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-divisi">Divisi</label>
                                     <input class="form-control input-air-primary" id="divisi" name="divisi" type="text" placeholder="Divisi" value="{{ $resain->divisi }}" readonly />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="tanggal" type="date" placeholder="Jumlah Hari Cuti" value="{{ $resain->tanggal }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $("#edit-form").submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "{{ url($information['route']) }}/update/{{ Crypt::encrypt($resain->id) }}",
                data: form_data,
                processData: false,
                contentType: false,
