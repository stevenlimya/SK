                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-reward" name="reward" type="text" placeholder="Masukkan Reward Yang Di Dapat" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="tanggal" type="date"/>
                                </div>
                            </div>
                        </div>
                    </div>
