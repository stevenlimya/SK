...
<div class="container-fluid">
    <div class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="#">
            ...
            <span class="breadcrumb-text">Data Cuti</span>
        </a>
        <a class="breadcrumb-item" href="#">
            <span class="breadcrumb-icon">
                <i data-feather="database"></i>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-keterangan" name="keterangan" type="text" placeholder="Alasan Izin" value="{{ $cuti->keterangan }}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="tanggal" type="date" placeholder="Jumlah Hari Izin" value="{{ $cuti->tanggal }}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="lama" type="text" placeholder="Jumlah Hari Izin" value="{{ $cuti->lama }}" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="row">                   
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <select name="acc" id="select-input-acc" class="form-control input-air-primary" required>
                                        <option value="{{ $cuti->acc }}" selected hidden>Pilih Approval</option>
                                        <option value="Diterima" {{ $cuti->acc === 'Diterima' ? 'selected' : '' }}>Diterima</option>
                                            <option value="Ditolak" {{ $cuti->acc === 'Ditolak' ? 'selected' : '' }}>Ditolak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
