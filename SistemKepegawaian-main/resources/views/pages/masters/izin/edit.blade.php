                ...
                <form class="form theme-form" id="edit-form" action="{{ url($information['route']) }}/update/{{ Crypt::encrypt($izin->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">                  
                        ...
                        <div class="row">                   
                            <div class="col">
                                <div class="mb-4">
                                    <label class="form-label" for="select-input-status">Status</label>
                                    <select name="status" id="select-input-status" class="form-control input-air-primary" required>
                                        <option value="{{ $izin->status }}" selected hidden>Pilih Status</option>
                                        <option value="Izin Tidak Bekerja" {{ $izin->status === 'Izin Tidak Bekerja' ? 'selected' : '' }}>Izin Tidak Bekerja</option>
                                            <option value="Izin Meninggalkan Pekerjaan" {{ $izin->status === 'Izin Meninggalkan Pekerjaan' ? 'selected' : '' }}>Izin Meninggalkan Pekerjaan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-keterangan" name="keterangan" type="text" placeholder="Alasan Izin" value="{{ $izin->keterangan }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="tanggal" type="date" placeholder="Jumlah Hari Izin" value="{{ $izin->tanggal }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggal" name="lama" type="text" placeholder="Jumlah Hari Izin" value="{{ $izin->lama }}"/>
                                </div>
                            </div>
                        </div>
