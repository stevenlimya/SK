...
class LokerController extends Controller
{
    ...
    // Proses input data yang diinput loker di view ke model
    public function store(Request $request)
    {
        $result = Loker::do_store($request);
    ...
    public function update($id, Request $request)
    {
        ...
        $result = Loker::do_update($decrypt->id, $request);
        return response()->json($result["client_response"], $result["code"]);
    }
    ...
    public function destroy($id)
    {
        ...
        $result = Loker::do_delete($decrypt->id);
        return response()->json($result["client_response"], $result["code"]);
    }
}
