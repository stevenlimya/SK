...
class PermintaanKaryawanController extends Controller
{
    public static $information = [
        ...
        "route" => "/master/permintaankaryawan",
        "view" => "pages.masters.permintaankaryawan."
    ];
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $permintaan_karyawan = PermintaanKaryawan::join('karyawan', 'karyawan.id', '=', 'permintaan_karyawan.karyawan_id')
            ->select("permintaan_karyawan.*", "karyawan.nama as nama");
            return DataTables::of($permintaan_karyawan)
                ->addIndexColumn()
    ...
    public function edit($id, Request $request)
    {
        ...
        $permintaan_karyawan = Permintaankaryawan::find($decrypt->id);

        return view(self::$information['view'] . 'edit', [
            "information" => self::$information,
            "permintaan_karyawan" => $permintaan_karyawan
        ]);
    ...
    {
        $result = PermintaanKaryawan::do_store($request);
    ...
    public function update($id, Request $request)
    {
        ...
        $result = PermintaanKaryawan::do_update($decrypt->id, $request);
        return response()->json($result["client_response"], $result["code"]);
    }
    ...
    public function destroy($id)
    {
        ...
        $result = PermintaanKaryawan::do_delete($decrypt->id);
        return response()->json($result["client_response"], $result["code"]);
    }
