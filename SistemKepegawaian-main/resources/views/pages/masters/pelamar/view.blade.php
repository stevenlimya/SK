                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-nama" name="nama" type="text" disabled placeholder="Nama" value="{{ $pelamar->nama }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">                   
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <select name="divisi" id="select-input-divisi" class="form-control input-air-primary" disabled required>
                        ...
                        <div class="row">                   
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <select name="jeniskelamin" id="select-input-jeniskelamin" class="form-control input-air-primary" disabled required>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-alamat" name="alamat" type="text" disabled placeholder="Alamat" value="{{ $pelamar->alamat }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-tanggallahir" name="tanggallahir" type="date" disabled placeholder="" value="{{ $pelamar->tanggallahir }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-notelepon" name="notelepon" type="text" disabled placeholder="+628" value="{{ $pelamar->notelepon }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-email" name="email" type="text" disabled placeholder="email" value="{{ $pelamar->email }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-nik" name="nik" type="text" disabled placeholder="Nomor NIK" value="{{ $pelamar->nik }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
