    ...
    $(function() {
        ...
        data_table = $("#index-table").DataTable({
            ...
            columns: [{
                ...
                {
                    name: "permintaan_karyawan.pemohon",
                    data: "pemohon"
                },
                {
                    name: "permintaan_karyawan.divisi_pemohon",
                    data: "divisi_pemohon"
                },
                {
                    name: "permintaan_karyawan.tanggal",
                    data: "tanggal"
                },
                {
                    name: "permintaan_karyawan.keterangan",
                    data: "keterangan"
                },
                {
                    name: "permintaan_karyawan.divisi",
                    data: "divisi"
                },
                {
                    data: "action",
