...
<div class="container-fluid">
    <div class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="#">
            ...
            <span class="breadcrumb-text">Tambah Izin </span>
        </a>
    </div>
                ...
                <form class="form theme-form" id="input-form" action="{{ url($information['route']) }}/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                    <div class="mb-4">
                                        ...
                                        <select name="status" id="select-input-status" class="form-control input-air-primary">
                                            <option value="" selected hidden>Pilih Status Izin</option>
                                            <option value="Izin Tidak Bekerja">Izin Tidak Bekerja</option>
                                            <option value="Izin Meninggalkan Pekerjaan">Izin Meninggalkan Pekerjaan</option>
                                        </select>
                                    </div>
                            </div>      
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control input-air-primary" id="txt-input-keterangan" name="keterangan" type="text" placeholder="Alasan Izin" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="txt-input-lama">Lama Waktu</label>
                                    <input class="form-control input-air-primary" id="txt-input-lama" name="lama" type="text" placeholder="Lama Waktu Izin" />
                                </div>
                            </div>
                        </div>
